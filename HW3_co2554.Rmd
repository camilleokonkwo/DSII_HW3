...
glmnGrid <- expand.grid(alpha = seq(0, 1, length = 50),
...
# create a logical vector where we compare the predictions from the MARS model to the actual test data responses 
